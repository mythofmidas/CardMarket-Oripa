          ...
          <div className="w-full bg-white shadow border-0 my-4 mx-auto rounded-lg">
            <CardBody className="px-md-4 py-md-4 px-2 py-2">
              ...
              <Form role="form">
                ...
                {!isVisible && <FormGroup>
                  <p className="p-1 font-bold text-xs">{t("confirm")} *</p>
                  <InputGroup className="input-group-alternative mb-1">
                    <Input
                      placeholder={t("password")}
                      type={isVisible ? "text" : "password"}
                      name="repassword"
                      className={`border-[1px] rounded-r-lg ${
                        showErrMessage && !formData.repassword ? "is-invalid" : ""
                      }`}
                  ...
                  {showErrMessage && ( !formData.repassword || formData.repassword !== formData.password)  ? (
                    <span className="flex text-sm text-red-600">
                      <i className="fa-solid fa-triangle-exclamation text-red-600 mr-2 mt-1"></i>
                      {!formData.repassword ? t("requiredPwd") : t("Pwdsame")}
                    </span>
                  ) : null}
                </FormGroup>}
                ...
                <FormGroup>
                  <p className="p-1 font-bold text-xs">{t("Invitecode")} *</p>
                  <InputGroup className="input-group-alternative mb-1">
                    <Input
